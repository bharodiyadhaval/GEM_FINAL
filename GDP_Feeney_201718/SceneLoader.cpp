...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...

	{
		cGameObject* pTempGO = new cGameObject();
		cPhysicalProperties physState;
		physState.position = glm::vec3(0, 300, 0);
		...
		meshInfo.coefficientRefract = 0.5f;
		pTempGO->friendlyName = "ball";
		...
		tempobj.ApplyPhysics = 1;
		tempobj.Mass = 50;
		tempobj.ObjectName = "Ball";
...

	{
		cGameObject* pTempGO = new cGameObject();
		cPhysicalProperties physState;
		physState.position = glm::vec3(0, 0, 0);
		pTempGO->SetPhysState(physState);
		sMeshDrawInfo meshInfo;
		meshInfo.bUseDebugColour = false;
		meshInfo.scale = 100.0f;
		meshInfo.name = "Metal_Plate";
		/*meshInfo.bIsEnvirMapped = true;
		...
		tempobj.ApplyPhysics = 1;
		tempobj.Mass = 0;
		tempobj.ObjectName = "Metal_Box";
		tempobj.PhysicsPosition = physState.position;
		tempobj.PhysicsScale = meshInfo.scale;
		tempobj.type = myInterface::BOX;
		::PhysicsVector.push_back(tempobj);
	...
	for(int i=1; i<=5; i++)
	{
		cGameObject* pTempGO = new cGameObject();
		cPhysicalProperties physState;
		physState.position = glm::vec3(80*i, 80*i, 80*i);
		pTempGO->SetPhysState(physState);
		sMeshDrawInfo meshInfo;
		meshInfo.bUseDebugColour = false;
		meshInfo.scale = 100.0f;
	...
	for (int i = 1; i <= 5; i++)
	{
		cGameObject* pTempGO = new cGameObject();
		cPhysicalProperties physState;
		physState.position = glm::vec3(700, 700, 400 * (i*1.2) );
		pTempGO->SetPhysState(physState);
		sMeshDrawInfo meshInfo;
		meshInfo.bUseDebugColour = false;
		meshInfo.scale = 100.0f;
	...
	for (int i = 1; i <= 5; i++)
	{
		cGameObject* pTempGO = new cGameObject();
		cPhysicalProperties physState;
		physState.position = glm::vec3(200, 700 * (i*1.2), 800);
		pTempGO->SetPhysState(physState);
		sMeshDrawInfo meshInfo;
		meshInfo.bUseDebugColour = false;
		meshInfo.scale = 100.0f;

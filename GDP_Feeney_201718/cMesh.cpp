...
void cMesh::CalculateNormals(void)
{
	...
	for ( int triIndex = 0; triIndex != this->numberOfTriangles; triIndex++ )
	{
		...
		glm::vec2 uv0 = glm::vec2(this->pVertices[curTri.vertex_ID_0].u1, this->pVertices[curTri.vertex_ID_0].v1);
		glm::vec2 uv1 = glm::vec2(this->pVertices[curTri.vertex_ID_1].u1, this->pVertices[curTri.vertex_ID_1].v1);
		glm::vec2 uv2 = glm::vec2(this->pVertices[curTri.vertex_ID_2].u1, this->pVertices[curTri.vertex_ID_2].v1);

		glm::vec3 deltaPos1 = vertB - vertA;
		glm::vec3 deltaPos2 = vertC - vertA;
		...
		this->pVertices[curTri.vertex_ID_0].tx = tangent.x;
		this->pVertices[curTri.vertex_ID_0].ty = tangent.y;
		this->pVertices[curTri.vertex_ID_0].tz = tangent.z;

		this->pVertices[curTri.vertex_ID_1].tx = tangent.x;
		this->pVertices[curTri.vertex_ID_1].ty = tangent.y;
		this->pVertices[curTri.vertex_ID_1].tz = tangent.z;

		this->pVertices[curTri.vertex_ID_2].tx = tangent.x;
		this->pVertices[curTri.vertex_ID_2].ty = tangent.y;
		this->pVertices[curTri.vertex_ID_2].tz = tangent.z;


		this->pVertices[curTri.vertex_ID_0].bx = bitangent.x;
		this->pVertices[curTri.vertex_ID_0].by = bitangent.y;
		this->pVertices[curTri.vertex_ID_0].bz = bitangent.z;

		this->pVertices[curTri.vertex_ID_1].bx = bitangent.x;
		this->pVertices[curTri.vertex_ID_1].by = bitangent.y;
		this->pVertices[curTri.vertex_ID_1].bz = bitangent.z;

		this->pVertices[curTri.vertex_ID_2].bx = bitangent.x;
		this->pVertices[curTri.vertex_ID_2].by = bitangent.y;
		this->pVertices[curTri.vertex_ID_2].bz = bitangent.z;

...
//	if ( ! ::g_pSkinnedMesh01->LoadMeshFromFile( "assets/modelsFBX/RPG-Character_Unarmed-Fall(FBX2013).fbx" ) ) 
	...
	{
		cMesh testMesh;
		testMesh.name = "Metal_Plate";
		if (!pModelAssetLoader->LoadPlyFileIntoMeshWith_Normals_and_UV("Metal_Plate.ply", testMesh))
		{
	...
	{
		cMesh testMesh;
		testMesh.name = "technosphere";
		if (!pModelAssetLoader->LoadPlyFileIntoMeshWith_Normals_and_UV("technosphere.ply", testMesh))
		{
			//std::cout << "Didn't load model" << std::endl;
			ssError << "Didn't load model >" << testMesh.name << "<" << std::endl;
			bAllGood = false;
	...
	{
		cMesh testMesh;
		testMesh.name = "screen";
		if (!pModelAssetLoader->LoadPlyFileIntoMeshWith_Normals_and_UV("tvscreen.ply", testMesh))
		{
			//std::cout << "Didn't load model" << std::endl;
			ssError << "Didn't load model >" << testMesh.name << "<" << std::endl;
			bAllGood = false;
...

	{
		cMesh testMesh;
		testMesh.name = "plane";
		if (!pModelAssetLoader->LoadPlyFileIntoMeshWith_Normals_and_UV("plane.ply", testMesh))
		{
			//std::cout << "Didn't load model" << std::endl;
			ssError << "Didn't load model >" << testMesh.name << "<" << std::endl;
			bAllGood = false;
	...
	//four_point_Particle.ply


	{
		cMesh testMesh;
		testMesh.name = "Piramid";
		if (!pModelAssetLoader->LoadPlyFileIntoMeshWith_Normals_and_UV("four_point_Particle.ply", testMesh))
		{
			//std::cout << "Didn't load model" << std::endl;
			ssError << "Didn't load model >" << testMesh.name << "<" << std::endl;
			bAllGood = false;
